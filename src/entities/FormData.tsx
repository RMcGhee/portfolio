 ...
 */
export const ddDataForYear = function (
  formData: FormData,
): [DegreeDayMonths, DegreeDayMonths] {
  switch (formData.dataYear) {
    case 2023:
      return [
        formData.degreeDayData.year_2023.cooling,
        formData.degreeDayData.year_2023.heating,
      ];
    case 2022:
      return [
        formData.degreeDayData.year_2022.cooling,
        formData.degreeDayData.year_2022.heating,
      ];
    case 2021:
      return [
        formData.degreeDayData.year_2021.cooling,
        formData.degreeDayData.year_2021.heating,
      ];
  }
};
